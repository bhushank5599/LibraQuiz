...
public class QuestionManagement {
    ...
    public QuestionManagement(Long id, Long questionId, WorkflowStatus status, Integer currentVersion, Long submittedByTeacherId, Long assignedReviewerId, String reviewFeedback, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
    ...
    public enum WorkflowStatus {
        DRAFT, UNDER_REVIEW, NEEDS_REVISION, APPROVED, PUBLISHED, ARCHIVED
    }
    ...
    public static class QuestionManagementBuilder {
        ...
        public QuestionManagementBuilder status(WorkflowStatus status) {
            this.status = status;
            return this;
        }
        ...
        public QuestionManagement build() {
            return new QuestionManagement(id, questionId, status, currentVersion, submittedByTeacherId, assignedReviewerId, reviewFeedback, createdAt, updatedAt);
        }
    }
}
